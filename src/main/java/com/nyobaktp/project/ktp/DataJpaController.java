 ...
 */
package com.nyobaktp.project.ktp;
...
import com.nyobaktp.project.ktpexceptions.NonexistentEntityException;
import com.nyobaktp.project.ktpexceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ktpindonesia_126_jar_0.0.1-SNAPSHOTPU");
